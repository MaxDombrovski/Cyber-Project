...
class Register_Window1(tkinter.Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.hats = ["assets/TopHat.png", "assets/Cap.png"]
        self.shirts = ["assets/WhiteShirt.png", "assets/Suit.png"]
        self.pants = ["assets/Jeans.png", "assets/Shorts.png"]
        self.shoes = ["assets/Sneakers.png", "assets/Crocs.png"]
    ...
    def image_update(self, evt):
        self.hat_image_path = Path("assets/" + self.combohat.get() + ".png")
        ...
        self.shirt_image_path = Path("assets/" + self.comboshirt.get() + ".png")
        ...
        self.pants_image_path = Path("assets/" + self.combopants.get() + ".png")
        ...
        self.shoes_image_path = Path("assets/" + self.comboshoes.get() + ".png")
        ...
        # canvas1.pack()
        # bg = canvas1.create_image(0, 0, anchor=NW, image=PhotoImage(file="assets/purple.png"))
